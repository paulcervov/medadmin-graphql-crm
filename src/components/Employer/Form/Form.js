                                ...
                                <div className="col-sm-3">
                                    <div className="form-group">
                                        ...
                                        >
                                            ...
                                            {Role.enums.map(role => <option value={role.value} key={role.value}>{RoleLabel.get(role)}</option>)}
                                        </select>
                                ...
                                <div className="col-sm-3">
                                    <div className="form-group">
                                        ...
                                        >
                                            ...
                                            {Gender.enums.map(gender => <option value={gender.value} key={gender.value}>{GenderLabel.get(gender)}</option>)}
                                        </select>
